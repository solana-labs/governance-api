...
export const InlineStyleStrikethrough = IT.literal(RTD.InlineStyle.Strikethrough);
...
export const InlineNodeType = IT.union([InlineNodeTypeAnchor, InlineNodeTypeInline]);
